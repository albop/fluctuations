...
if T_flag
    T = two_agents_mps.static_g1_tt(T, y, x, params);
end
g1 = zeros(10, 10);
g1(1,1)=1-exp(x(1))*params(10)*1/params(10)*getPowerDeriv(y(1)/params(10),params(5),1);
g1(2,2)=1-params(6);
g1(3,5)=1;
g1(3,7)=(-(1/params(14)));
g1(4,6)=1;
...
g1(9,8)=(-((-1)/(y(8)*y(8))));
g1(9,9)=1;
g1(10,7)=(-(1/params(14)/(params(10)/params(14))/params(16)));
g1(10,10)=1;
if ~isreal(g1)
