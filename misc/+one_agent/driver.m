...
M_.param_names(8) = {'zbar'};
M_.param_names_tex(8) = {'zbar'};
M_.param_names_long(8) = {'zbar'};
M_.param_names(9) = {'ybar'};
M_.param_names_tex(9) = {'ybar'};
M_.param_names_long(9) = {'ybar'};
M_.param_names(10) = {'bbar'};
M_.param_names_tex(10) = {'bbar'};
M_.param_names_long(10) = {'bbar'};
M_.param_names(11) = {'cbar'};
M_.param_names_tex(11) = {'cbar'};
M_.param_names_long(11) = {'cbar'};
M_.param_names(12) = {'chi'};
M_.param_names_tex(12) = {'chi'};
M_.param_names_long(12) = {'chi'};
M_.param_names(13) = {'sig_y'};
M_.param_names_tex(13) = {'sig\_y'};
M_.param_names_long(13) = {'sig_y'};
...
M_.params(10) = 0.0;
bbar = M_.params(10);
M_.params(11) = M_.params(9)+M_.params(10)*(1-M_.params(3));
cbar = M_.params(11);
M_.params(6) = 0.6;
eta = M_.params(6);
M_.params(7) = 0.05;
...
save([M_.dname filesep 'Output' filesep 'one_agent_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'one_agent_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'one_agent_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'one_agent_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'one_agent_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'one_agent_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'one_agent_results.mat'], 'oo_recursive_', '-append');
end
if ~isempty(lastwarn)
