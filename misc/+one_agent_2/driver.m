...
M_.param_names(9) = {'bbar'};
M_.param_names_tex(9) = {'bbar'};
M_.param_names_long(9) = {'bbar'};
...
M_.param_names(12) = {'sig_z'};
M_.param_names_tex(12) = {'sig\_z'};
M_.param_names_long(12) = {'sig_z'};
...
M_.equations_tags = {
  1 , 'name' , 'income process' ;
  2 , 'name' , 'budget equation' ;
  3 , 'name' , 'euler equation' ;
};
M_.mapping.y.eqidx = [1 2 ];
M_.mapping.c.eqidx = [2 3 ];
M_.mapping.b.eqidx = [2 3 ];
...
M_.params(9) = 0.0;
bbar = M_.params(9);
M_.params(10) = M_.params(8)+M_.params(9)*(1-M_.params(3));
cbar = M_.params(10);
M_.params(6) = 1.1;
eta = M_.params(6);
M_.params(7) = 0.05;
phi = M_.params(7);
M_.params(1) = 1/M_.params(2)-M_.params(7)*(1+M_.params(9)*M_.params(3))^((-1)/M_.params(6))/M_.params(10)^((-1)/M_.params(4));
beta = M_.params(1);
%
% SHOCKS instructions
%
...
save([M_.dname filesep 'Output' filesep 'one_agent_2_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'one_agent_2_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'one_agent_2_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'one_agent_2_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'one_agent_2_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'one_agent_2_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'one_agent_2_results.mat'], 'oo_recursive_', '-append');
end
if ~isempty(lastwarn)
