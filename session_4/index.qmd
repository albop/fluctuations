---
title: "The price of carbon and the DICE model"
author: "Pablo Winant"
...
![Past temperatures (from CO2 trapped in ice cores)](assets/global_temperatures_past.png){height=50%}
...
![Risk Assessment (ICCP 2022)](assets/iccp_risk.png){height=100%}
...
Immediate conclusion: over the long-run, the world needs to target zero-emission.[^henriet]

::::
:::

[^henriet]: If you want to know more about this topic, I suggest: *La Transition Energétique, Objectif Zen* by Fanny Henriet and Katheline Schubert.
...
![Carbon Budget and Fossil Fuels](assets/fuel.png){width=60%}
...
From [*Yellow vests, pessimistic beliefs, and carbon tax aversion*](https://cepr.org/voxeu/columns/public-support-carbon-taxation-lessons-france), Fabre and Douenne (2022)

Which carbon reducing reform is supported by citizens?
...
::: columns
:::: column
![A super nice plastic bag](assets/plasticbag.png){#fig-plastic width=100}
::::
:::: column
![A boring cotton tote bag](assets/tote_bag.png){#fig-tote width=100}
::::
:::
...
- tote bag: 270Kg of CO2e, mostly production of cotton
...
- several variants
    - RICE: disaggregated countries
    - 1992, 2013, 2016, 2023: updates to new state of the art
...
![Meta-Analysis](assets/howard_and_sterner.png){widh=100%}
...
$$\max_{c_t} W =  \int_0^{\infty} U[c(t)] e^{-\rho t} dt$$
s.t.
$$c(t) = M(y(t), z(t); α, ε(t))$$
...
- here it is a positive model: without inefficiency the $\max$ is a model of how market work
...
Social price of carbon can also be defined along the optimal as:
...
![](assets/social_cost_of_carbon.png){height=50%}
...
- 1997: Kyoto protocol
    ...
    - protocol was aiming to cover 2/3 of global emissions but ended up covering 1/3 only
    - emissions grew faster in non-participating countries

## Climate agreements (3)
...
![assets/weo-ch3-chart-2.png](assets/weo-ch3-chart-2.png){height=50%}
...
And yet it feels somewhat disappointing: shouldn't we expect more from private agents (citizens) and states?

. . .

- Possibly but economists are not state planificators and don't choose people's preferences.
 
. . .

Although... according to recent Nick Stern column, [For climate economics, preferences can and should be treated as endogenous](https://cepr.org/voxeu/columns/climate-economics-preferences-can-and-should-be-treated-endogenous)