...
Immediate conclusion: over the long-run, the world needs to target zero-emission

::: aside

If you want to know more about this topic, I suggest: *La Transition Energétique, Objectif Zen* by Fanny Henriet and Katheline Schubert.
...
![A super nice plastic bag](assets/plasticbag.png){#fig-plastic width=400}

![A boring cotton tote bag](assets/tote_bag.webp){#fig-tote width=400}
...
Although... according to Nick Stern [For climate economics, preferences can and should be treated as endogenous](https://cepr.org/voxeu/columns/climate-economics-preferences-can-and-should-be-treated-endogenous)
